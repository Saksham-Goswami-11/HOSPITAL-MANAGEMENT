  ...
  return (
    <div className="relative bg-white pt-24 pb-16 lg:pt-32 lg:pb-24 overflow-hidden border-b border-slate-100">
      ...
      <div className="absolute inset-0 z-0">
        <div className="absolute top-0 left-1/4 w-96 h-96 bg-primary/15 rounded-full filter blur-[100px] animate-pulse duration-[4000ms]"></div>
        <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-cyan-400/15 rounded-full filter blur-[100px] animate-pulse duration-[5000ms]"></div>
      </div>
