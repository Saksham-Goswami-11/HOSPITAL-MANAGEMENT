...
const Footer: React.FC = () => {
  return (
    <footer className="bg-slate-50 border-t border-slate-200 text-slate-600 py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 lg:grid-cols-5 gap-8 md:gap-12 mb-16">
        ...
        <div className="border-t border-slate-200 pt-12 pb-8">
          <div className="flex flex-wrap justify-center items-center gap-4 sm:gap-8 md:gap-16 opacity-70 hover:opacity-100 transition-opacity">
            ...
            <div className="flex items-center gap-2">
              <img src="https://img.icons8.com/ios-filled/50/000000/security-shield.png" alt="SOC 2" className="w-8 opacity-60" />
